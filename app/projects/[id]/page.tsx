...
export default async function ProjectDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { project, milestones, updates, alerts, alertsError, error } = await getProjectDetails(decodeURIComponent(id));
